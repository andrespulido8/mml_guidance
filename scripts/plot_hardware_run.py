...
def main():
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith(".csv"):
            ...
            beg_end = np.array([0.0, 0.90]) if filename == 'Information_2023-07-06-16-46-55_joined.csv' else beg_end
                ...
                if print_rms:
                    if any(col_name == word for word in include_data):
                        ...
                        with open(outdir + 'rms.csv', 'a') as csvfile:
                            ...
                            perc = round(100 * np.sum(df[col_name].dropna()) / len(df[col_name].dropna()), 3)
            ...
            if filename == 'Information_2023-07-06-16-53-57_joined.csv':
                ...
                plt.scatter(df['rail nwu pose stamped position x'].dropna().iloc[14464:14464+690:40], df['rail nwu pose stamped position y'].dropna().iloc[14464:14464+690:40], s=35, c='darkblue', marker='+', label='Turtlebot Future Positions')
